 ...
 *
 * <p>
 * Maps to the {@code t_transaction_details} table and is used by the repository
 * layer to persist and load transaction data. The entity is intentionally
 * simple and does not contain business logic; business rules are implemented in
 * the service layer where transactions are interpreted and aggregated into
 * reward points.
 *
 * <p>
 * Fields correspond directly to table columns and are accessed via standard
 * JavaBean accessors. Avoid placing business logic here to keep the entity
