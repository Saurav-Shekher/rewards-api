 ...
 *
 * <p>
 * This DTO is returned by the controller and serialized to JSON for API
 * clients. It contains the points accumulated in three time windows (0-30,
 * 31-60 and 61-90 days) and a computed total. The DTO is intentionally simple
 * and provides read-only accessors for serialization and test assertions.
 *
 * @author Rewards
 * @since 0.0.1
 */
